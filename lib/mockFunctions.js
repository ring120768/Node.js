...
- DO NOT invent, infer, speculate, or add any details not clearly stated
- If information is missing or unclear, explicitly state "Not mentioned" or "Details not provided"
- Use neutral, objective language without blame or fault attribution
- Focus on observable facts and direct statements from the transcription
...
- If the transcription is insufficient, state this clearly
...
If the transcription contains insufficient factual information (less than 5 concrete facts), respond with:
"There is not currently enough data to provide you with a substantial summary. The transcription contains insufficient factual details for a comprehensive legal summary."

Please provide a structured summary of the following transcription:`;

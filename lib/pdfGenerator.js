...
async function generatePDF(data) {
  try {
    ...
    setFieldText('nearestLandmark', incident.nearestLandmark || '');
    setFieldText('additionalHazards', incident.additionalHazards || '');
    setFieldText('visibilityFactors', incident.visibilityFactors || '');

    // NEW: Junction/Intersection Details (migration 002)
    setFieldText('junctionType', incident.junctionType || '');
    setFieldText('junctionControl', incident.junctionControl || '');
    setFieldText('trafficLightStatus', incident.trafficLightStatus || '');
    setFieldText('userManoeuvre', incident.userManoeuvre || '');
    ...
    setFieldText('impact', incident.impact_point || incident.impact); // NEW: Migration 002 - explicit impact_point column
    ...
    setFieldText('other_driver_email', otherVehicle.other_driver_email || ''); // NEW: Migration 002
    ...
    // Page 9 - Police Involvement (UPDATED for migration 002)
    checkField('did_police_attend', incident.police_attended === true || incident.did_the_police_attend_the_scene === 'Yes' || incident.did_police_attend === 'Yes');
    ...
    // NEW: Final Feeling/Thoughts (migration 002)

...
async function generatePDF(data) {
  try {
    ...
    // Note: user_id field appears on multiple pages (duplicate field)
    // Setting it once will fill all instances throughout the document
    ...
    // ========================================
    // PAGE 13: AI Summary (Matches PDF)
    // ========================================
    console.log('   📄 Page 13: AI Summary');

    if (aiSummary && aiSummary.summary_text) {
      // We have AI summary data from the ai_summary table
    ...
    // ========================================
    // PAGE 14: AI Transcription (Matches PDF)
    // ========================================
    console.log('   📄 Page 14: AI Transcription');

    if (aiTranscription && aiTranscription.transcription_text) {
      // We have AI transcription data from the ai_transcription table

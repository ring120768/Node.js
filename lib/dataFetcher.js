...
async function fetchAllData(createUserId) {
  try {
    ...
    // ========================================
    // Fetch AI analysis data for PDF Pages 13-16:
    ...
    if (!analysisError && analysis) {
      aiAnalysisData = {
        id: analysis.id,
        voice_transcription: analysis.voice_transcription || '',     // Page 13: Optional Whisper transcription
        analysis_metadata: analysis.analysis_metadata || {},          // Page 13: GPT model info, timestamp
        quality_review: analysis.quality_review || '',                // Page 13: Quality assessment
        ai_summary: analysis.ai_summary || '',                        // Page 14: Summary & Key Points
        closing_statement: analysis.closing_statement || '',          // Page 15: Legal closing statement
        final_review: analysis.final_review || '',                    // Page 16: Next steps & recommendations

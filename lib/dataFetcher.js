  ...
  try {
    ...
    if (incidentData && incidentData.length > 0) {
      ...
      if (witnessesError) {
        ...
        // Map DB column names to match pdfGenerator.js expectations
        witnessesData = witnesses.map(witness => ({
          witness_number: witness.witness_number,
          witness_name: witness.witness_name,
          witness_phone: witness.witness_mobile_number,  // Map to witness_phone for PDF
          witness_email: witness.witness_email_address,  // Map to witness_email for PDF
    ...
    // PDF generators (pdf.controller.js, pdfGenerator.js) expect these SHORT keys
    const documentTypeToImageUrlKey = {
      ...
      // Scene overview images (legacy naming)
      'scene_overview': 'scene_overview',
      'scene_overview_1': 'scene_overview',
      'scene_overview_2': 'scene_overview_2',
      'scene_overview_3': 'scene_overview_3',

...
async function fetchAllData(createUserId) {
  try {
    ...
    // ========================================
    // AI ANALYSIS (Pages 14-15)
    // ========================================
    // Fetch comprehensive AI analysis data for PDF Pages 14-15:
    // - Page 14: Comprehensive closing statement narrative (combined_report)
    // - Page 15: Bullet points (key_points) + Next steps guide (final_review.nextSteps)

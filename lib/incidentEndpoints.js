...
class IncidentEndpoints {
  ...
  async storeEvidenceAudio(req, res) {
    try {
      ...
      console.error('Error storing evidence audio:', error);
  ...
  async uploadWhat3WordsImage(req, res) {
    try {
      ...
      console.log('What3Words image uploaded successfully');
      res.json({
        success: true,
        storagePath: fileName,
        publicUrl
  ...
  async uploadDashcam(req, res) {
    try {
      ...
      console.log('Dashcam uploaded successfully');
      res.json({
        success: true,
        fileUrl: publicUrl,
        storagePath: fileName
      ...
      console.error('Error uploading dashcam:', error);

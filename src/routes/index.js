...
const dashboardRoutes = require('./dashboard.routes'); // NEW: Dashboard routes for viewing reports
...
router.use('/api/dashboard', dashboardRoutes); // NEW: Dashboard routes for viewing reports

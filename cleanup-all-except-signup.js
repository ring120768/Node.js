/**
 * DESTRUCTIVE OPERATION: Delete ALL test data EXCEPT user_signup
 *
 * This script:
 * - Deletes all incident-related data
 * - Deletes all files from Storage buckets
 * - PRESERVES user_signup table
...
async function deleteAllData() {
  ...
  console.log('✅ PRESERVING: user_signup table\n');

  const results = {
    tables: {},
    storage: {},
    errors: [],
    preserved: ['user_signup']
  };

  // Delete tables in correct order (respecting foreign keys)
  // NOTE: user_signup is EXCLUDED from this list
  ...
  console.log('\n🔒 PRESERVED:');
  console.log('   ✅ user_signup table (all user accounts intact)');
  console.log('   ✅ Auth users (can still log in)');

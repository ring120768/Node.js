-- =============================================
-- Migration 015: Add Six Point Safety Check Field to user_signup
-- Created: 2025-11-06
...
DO $$
BEGIN
  RAISE NOTICE '✅ Migration 015 complete: Six point safety check field added';
...
--
-- ALTER TABLE user_signup DROP COLUMN IF EXISTS six_point_safety_check_completed_at;
-- ALTER TABLE user_signup DROP COLUMN IF EXISTS six_point_safety_check;
--
-- COMMIT;

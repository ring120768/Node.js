-- =============================================
-- Migration 014: Add are_you_safe Boolean Field to user_signup
-- Created: 2025-11-06
-- Purpose: Implement safety check boolean for access control and analytics
-- Based on: SAFETY_CHECK_BOOLEAN_IMPLEMENTATION.md
-- =============================================
...
DO $$
BEGIN
  RAISE NOTICE '✅ Migration 014 complete: are_you_safe boolean field added';
